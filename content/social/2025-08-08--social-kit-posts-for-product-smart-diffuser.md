---
title: 'social kit posts for product smart diffuser'
date: '2025-08-08'
brand: 'SoftFrequency'
target_country: 'US'
...
You are a social strategist for SoftFrequency.
Task: Create a 7-post cross-platform kit supporting: posts for product Smart Diffuser

Deliver:
- Instagram: caption + 10 hashtags
- TikTok: 1-line hook + 3-beat outline + on-screen subtitle text
- Pinterest: pin title + description
- YouTube Shorts: title + 2-line description + 3 tags
- X: 2 concise variations
- LinkedIn: value-led mini-post

Rules:
- Each post hits a unique benefit angle.
- No hype. Minimal, cinematic, warm tone.
- End with a soft CTA.
